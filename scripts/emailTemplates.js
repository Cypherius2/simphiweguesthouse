    ...
    return `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; border: 1px solid #ddd; border-radius: 8px; overflow: hidden;">
            ...
            <div style="padding: 20px;">
                ...
                <div style="text-align: center; margin-top: 30px;">
                    <a href="mailto:simphiwe.guesthouse@gmail.com?subject=Re:%20New%20Review%20Feedback" style="display: inline-block; padding: 12px 25px; background-color: #00796b; color: white; text-decoration: none; border-radius: 5px; font-weight: bold; font-size: 16px;">
                        REPLY TO GUEST OR DISCUSS INTERNALLY
                    </a>
                </div>
            </div>
            <div style="background-color: #f1f1f1; padding: 15px; text-align: center; font-size: 12px; color: #777;">
